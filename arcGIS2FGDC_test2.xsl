...
<!--updated to include moving raster cellsize and bands to fgdc.xml  Tvalentine 2/26/2013 -->
<!--updated to remove space in altcitation line 3990 causing space in the object name  tvalentine 10/8/2014 -->
	...
	<xsl:template name="spdoinfo">
		<xsl:if test="((/metadata/dataIdInfo[1]/spatRpType/SpatRepTypCd/@value = '001') or (/metadata/dataIdInfo[1]/spatRpType/SpatRepTypCd/@value = '002') or /metadata/spdoinfo/ptvctinf/esriterm or /metadata/spatRepInfo/VectSpatRep/geometObjs or /metadata/spatRepInfo/*/axisDimension or /metadata/contInfo/*/contentTyp/ContentTypCd/@value or /metadata/spatRepInfo/*/cellGeo/CellGeoCd/@value or (/metadata/spatRepInfo/Indref != ''))">
			<spdoinfo>
				...
				<xsl:if test="(/metadata/spatRepInfo/*/axisDimension) or (metadata/RasterProperties/general/NumBands/@value) or (/metadata/contInfo/*/contentTyp/ContentTypCd/@value) or (/metadata/spatRepInfo/*/cellGeo/CellGeoCd/@value) or (/metadata/dataIdInfo[1]/spatRpType/SpatRepTypCd/@value = '002')">
					<rastinfo>
						<xsl:choose>
						...
						<xsl:for-each select="(/metadata/spatRepInfo/*/axisDimension[@type = '001']/dimResol/value)[1]">
							<xcellsize>
								<xsl:value-of select="."/>
							</xcellsize>
						</xsl:for-each>
						<xsl:for-each select="(/metadata/spatRepInfo/*/axisDimension[@type = '002']/dimResol/value)[1]">
							<ycellsize>
								<xsl:value-of select="."/>
							</ycellsize>
						</xsl:for-each>
						<xsl:if test="/metadata/Esri/DataProperties/RasterProperties/General/NumBands !='.'">
							<numbands>
								<xsl:value-of select="/metadata/Esri/DataProperties/RasterProperties/General/NumBands"/>
							</numbands>
						</xsl:if>
					</rastinfo>
				</xsl:if>
